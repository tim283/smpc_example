function [t, x, u, comp_time] = nmpc(runningcosts, terminalcosts, ...
    ...
    while(mpciter < mpciterations)
        ...
        if ( iprint >= 1 )
            printSolution(system, printHeader, printClosedloopData, ...
                          plotTrajectories, mpciter, T, t0, x0, u_new, params, ...
...
function [u, V, exitflag, output] = solveOptimalControlProblem ...
    ...
    linearconstraints, system, cov_propagation, N, t0, x0, u0, T, sig, beta, params, ...
    atol_ode_sim, rtol_ode_sim, tol_opt, options, type)
...
function printSolution(system, printHeader, printClosedloopData, ...
             plotTrajectories, mpciter, T, t0, x0, u, params, ...
    ...
    if ( iprint >= 5 )
        plotTrajectories(@dynamic, system, T, t0, x0, u, atol_ode, rtol_ode, type, params)
    end
end
